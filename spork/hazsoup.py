...
class CloudBase:
    ...
    def init_ec2(self):
        ...
        self.upload_all("reduce_util.py")
        self.upload_all(DEFAULT_CONFIG_FILE)
        self.upload_all(self.keypair_file)
        self.run_all(f"chmod 400 {self.keypair_file}")
